...
export const translations: Record<Lang, TranslationKeys> = {
  en: {
    ...
    projects: {
      ...
      github: "View GitHub →",
      p1: { type: "MERN · Web App", title: "Next JS Portfolio", desc: "Premium personal portfolio with React, TypeScript and Tailwind CSS. Dark/light mode, multi-language support and smooth animations." },
      p2: { type: "MERN · Full Stack", title: "Class Competition", desc: "A responsive full-stack educational platform built to create classroom competition through interactive features, practical tools and engaging learning experiences." },
      p3: { type: "Social Media · Creative", title: "Social Media Management ", desc: "Creating professional content, managing online communities and handling digital platforms including Discord and social media accounts." },
    },
    ...
    footer: "Made with love by @ilyass — 2026",
  },
  fr: {
    ...
    about: {
      ...
      focus: "Focus", focusVal: "Dev MERN", stack: "Stack", style: "Style", styleVal: "Moderne & Propre",
    ...
    projects: {
      ...
      p2: { type: "MERN · Full Stack", title: "Classe Compétitive", desc: "Une plateforme éducative full-stack et responsive conçue pour créer une compétition saine entre les étudiants en classe grâce à des fonctionnalités interactives, des outils pratiques et une expérience d’apprentissage engageante." },
      p3: { type: "Réseaux Sociaux · Créatif", title: "Gestion des Réseaux Sociaux", desc: "Création de contenu professionnel, gestion de communautés en ligne et administration de plateformes numériques, y compris Discord et les réseaux sociaux." },
    },
  ...
  de: {
    ...
    journey: {
      ...
      card1: { title: "Abitur Wirtschaft & Lernen", sub: "Akademische Grundlage", text: "Begann Programmierung und Technologie während des Wirtschaftsstudiums zu entdecken. Entwickelte schnell starke Neugier für Code und digitale Kreation als Grundlage für einen technischen Weg." },
      card2: { title: "Bachelor Angewandte Wirtschaft, Arbeit", sub: "Université Ibn Zohr · Freelance", text: "Aktuell Studium der Angewandten Wirtschaftswissenschaften an der Université Ibn Zohr, während praktische Erfahrungen durch Freelance-Management und Landing-Page-Entwicklung ausgebaut werden. Fokus auf Studienabschluss und parallele Entwicklung digitaler und kreativer Fähigkeiten." },
    ...
    projects: {
      ...
      p2: { type: "MERN · Full Stack", title: "Wettbewerbsklasse", desc: "Eine responsive Full-Stack-Lernplattform, entwickelt, um einen gesunden Wettbewerb zwischen Schülern im Klassenzimmer durch interaktive Funktionen, praktische Werkzeuge und motivierende Lernerfahrungen zu schaffen." },
      p3: { type: "Social Media · Kreativ", title: "Social Media Management", desc: "Erstellung professioneller Inhalte, Verwaltung von Online-Communities und Betreuung digitaler Plattformen, einschließlich Discord und sozialer Netzwerke." },
    },
    ...
    footer: "Erstellt mit liebe von @ilyass — 2026",
  },
};
