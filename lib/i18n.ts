...
export const translations: Record<Lang, TranslationKeys> = {
  en: {
    ...
    about: {
      ...
      location: "Location", locationSub: "Based in Morocco. Available for remote projects and digital collaborations.",
    ...
    journey: {
      ...
      card2: { title: "Bachelor Applied Economics & Freelance", sub: "Université Ibn Zohr · Freelance", text: "Currently studying Applied Economics at Université Ibn Zohr, with a strong commitment to completing my License degree while continuously developing practical experience in freelance management and landing page development. Passionate about combining academic knowledge with digital creativity, I am focused on growing both professionally and personally through technology, communication and real-world projects."},
    ...
    projects: {
      ...
      github: "View GitHub →",
      p1: { type: "MERN · Portfolio Web", title: "Portfolio Web", desc: "Premium personal portfolio with React, TypeScript, Next JS and Tailwind CSS. Dark/light mode, multi language support and smooth animations." },
      p2: { type: "MERN · Full Stack", title: "Challenges Class ", desc: "A responsive full-stack web application designed to create healthy competition between students inside the classroom. The platform includes multiple practical features and interactive functionalities that encourage engagement, performance tracking and classroom participation, making learning more dynamic and competitive." },
      p3: { type: "Social Media · Creative", title: "Social Media Management", desc: "Professional social media and community management experience, including Discord servers and Twitter accounts, with skills in content creation, moderation and audience engagement." },
    },
