              ...
              <div style={{ display: "flex", padding: "0" }}>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <span style={{ color: "rgba(255,255,255,0.3)" }}>:</span>
                    {" "}<span style={{ color: "#fbbf24" }}>&#39;MERN Stack Developer / Photographer / Social Media Management.&#39;</span>
                    <span style={{ color: "rgba(255,255,255,0.3)" }}>,</span>
                  </div>
                  <div>
                  ...
                  <div>{"    "}<span style={{ color: "#fbbf24" }}>&#39;Next JS&#39;</span><span style={{ color: "rgba(255,255,255,0.3)" }}>,</span></div>
